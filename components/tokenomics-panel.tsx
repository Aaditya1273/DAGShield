    ...
    <Card className="bg-card border-border">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="text-black font-bold">+89 DAG</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-black font-medium">Node Uptime</span>
              <span className="text-black font-bold">+124 DAG</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-black font-medium">Community Challenge</span>
              <span className="text-black font-bold">+34 DAG</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-3 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
          ...
          <div className="text-xs text-black font-medium mt-1">36/50 threats detected</div>
        </div>
      </CardContent>
    </Card>
  )
